...
description: Use when interactive installer for Everything Claude Code — guides users through selecting and installing skills and rules to user-level or project-level directories, verifies paths, and optionally optimizes installed files.
tags: [rule, configure]
triggers: [configure, level, interactive, installer]
confidence: 0.85
