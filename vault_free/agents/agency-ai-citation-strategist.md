...
description: Use when expert in AI recommendation engine optimization (AEO/GEO) — audits brand visibility across ChatGPT, Claude, Gemini, and Perplexity, identifies why competitors get cited instead, and delivers content fixes that improve AI citations
tags: [citation, strategist]
triggers: [citation, strategist, recommendation, engine]
confidence: 0.8
uses: 0
---
