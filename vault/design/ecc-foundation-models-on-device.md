...
description: Use when apple FoundationModels framework for on-device LLM — text generation, guided generation with @Generable, tool calling, and snapshot streaming in iOS 26+.
tags: [ui, foundation, models, device]
triggers: [foundation, models, device, generation]
confidence: 0.85
