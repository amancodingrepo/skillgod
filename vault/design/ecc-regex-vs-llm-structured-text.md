...
description: Use when decision framework for choosing between regex and LLM when parsing structured text — start with regex, add LLM only for low-confidence edge cases.
tags: [regex, structured]
triggers: [regex, structured, text, decision]
confidence: 0.85
