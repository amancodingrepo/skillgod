...
description: Use when compose Multiplatform and Jetpack Compose patterns for KMP projects — state management, navigation, theming, performance, and platform-specific UI.
tags: [ui, compose, multiplatform, patterns]
triggers: [compose, multiplatform, patterns, jetpack]
confidence: 0.85
