...
description: Use when thread-safe data persistence in Swift using actors — in-memory cache with file-backed storage, eliminating data races by design.
tags: [design, swift, actor, persistence]
triggers: [swift, actor, persistence, data]
confidence: 0.85
