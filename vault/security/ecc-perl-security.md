...
description: Use when comprehensive Perl security covering taint mode, input validation, safe process execution, DBI parameterized queries, web security (XSS/SQLi/CSRF), and perlcritic security policies.
tags: [security, xss, csrf]
triggers: [perl, security, comprehensive, covering]
confidence: 0.85
