...
description: Use when "Use when auditing Claude skills and commands for quality. Supports Quick Scan (changed skills only) and Full Stocktake modes with sequential subagent batch evaluation."
tags: [scan, audit, stocktake]
triggers: [skill, stocktake, skills, auditing]
confidence: 0.85
