...
description: Use when verification loop for Laravel projects: env checks, linting, static analysis, tests with coverage, security scans, and deployment readiness.
tags: [security, scan, laravel, verification]
triggers: [laravel, verification, loop, projects]
confidence: 0.85
