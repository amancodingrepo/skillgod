...
description: Use when laravel security best practices for authn/authz, validation, CSRF, mass assignment, file uploads, secrets, rate limiting, and secure deployment.
tags: [security, csrf, laravel]
triggers: [laravel, security, best, practices]
confidence: 0.85
