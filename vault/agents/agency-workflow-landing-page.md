...
description: Use when # Multi-Agent Workflow: Landing Page Sprint  > Ship a conversion-optimized landing page in one day using 4 agents.  ## T
tags: [agent, multi-agent, workflow, landing]
triggers: [workflow, landing, page, multi]
confidence: 0.8
uses: 0
---
