...
description: Use when # 📋 NEXUS Handoff Templates  > Standardized templates for every type of agent-to-agent handoff in the NEXUS pipeline. Co
tags: [agent, handoff, templates]
triggers: [handoff, templates, nexus, standardized]
confidence: 0.8
uses: 0
---
