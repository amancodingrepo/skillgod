...
description: Use when expert in conversion tracking architecture, tag management, and attribution modeling across Google Tag Manager, GA4, Google Ads, Meta CAPI, LinkedIn Insight Tag, and server-side implementations. Ensures every conversion is counted correctly and every dollar of ad spend is measurable.
tags: [specialist, tracking, measurement]
triggers: [tracking, measurement, conversion, google]
confidence: 0.8
uses: 0
---
