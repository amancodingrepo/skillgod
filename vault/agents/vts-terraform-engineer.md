...
description: Use when "Use when building, refactoring, or scaling infrastructure as code using Terraform with focus on multi-cloud deployments, module architecture, and enterprise-grade state management."
tags: [terraform, engineer]
triggers: [terraform, engineer, building, refactoring]
confidence: 0.82
