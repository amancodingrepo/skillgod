...
description: Use when # ⚡ NEXUS Quick-Start Guide  > **Get from zero to orchestrated multi-agent pipeline in 5 minutes.**  ---  ## What is NEX
tags: [agent, orchestrate, multi-agent, quickstart]
triggers: [quickstart, nexus, quick, start]
confidence: 0.8
uses: 0
---
