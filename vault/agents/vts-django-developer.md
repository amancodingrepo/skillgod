...
description: Use when "Use when building Django 4+ web applications, REST APIs, or modernizing existing Django projects with async views and enterprise patterns."
tags: [django, developer]
triggers: [django, developer, building, applications]
confidence: 0.82
