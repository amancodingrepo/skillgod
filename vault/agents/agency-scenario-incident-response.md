...
description: Use when # 🚨 Runbook: Incident Response  > **Mode**: NEXUS-Micro | **Duration**: Minutes to hours | **Agents**: 3-8  ---  ## Scen
tags: [agent, scenario, incident, response]
triggers: [scenario, incident, response, runbook]
confidence: 0.8
uses: 0
---
