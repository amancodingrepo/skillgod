...
description: Use when "Use this agent when designing enterprise Java architectures, migrating Spring Boot applications, or establishing microservices patterns for scalable cloud-native systems."
tags: [agent, architect]
triggers: [java, architect, designing, enterprise]
confidence: 0.82
