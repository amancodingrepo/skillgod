...
description: Use when "Use this agent when building Electron desktop applications that require native OS integration, cross-platform distribution, security hardening, and performance optimization. Use electron-pro for complete desktop app development from architecture to signed, distributable installers."
tags: [agent, electron]
triggers: [electron, desktop, building, applications]
confidence: 0.82
