...
description: Use when # Workflow Example: Book Chapter Development  > A focused single-agent workflow for turning rough source material into a
tags: [agent, workflow, chapter]
triggers: [workflow, book, chapter, example]
confidence: 0.8
uses: 0
---
