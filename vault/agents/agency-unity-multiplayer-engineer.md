...
description: Use when networked gameplay specialist - Masters Netcode for GameObjects, Unity Gaming Services (Relay/Lobby), client-server authority, lag compensation, and state synchronization
tags: [specialist, unity, multiplayer, engineer]
triggers: [unity, multiplayer, engineer, networked]
confidence: 0.8
uses: 0
---
