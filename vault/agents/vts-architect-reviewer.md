...
description: Use when "Use this agent when you need to evaluate system design decisions, architectural patterns, and technology choices at the macro level."
tags: [agent, architect, reviewer]
triggers: [architect, reviewer, need, evaluate]
confidence: 0.82
