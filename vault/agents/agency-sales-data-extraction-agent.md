...
description: Use when aI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting
tags: [agent, sales, extraction]
triggers: [sales, data, extraction, specialized]
confidence: 0.8
uses: 0
---
