...
description: Use when "Use this agent when you need to design and execute controlled failure experiments, validate system resilience before incidents occur, or conduct game day exercises to test your team's incident response capabilities."
tags: [agent, chaos, engineer]
triggers: [chaos, engineer, need, design]
confidence: 0.82
