...
description: Use when "Use when establishing observability infrastructure to track system metrics, detect performance anomalies, and optimize resource usage across multi-agent environments."
tags: [agent, multi-agent, performance, monitor]
triggers: [performance, monitor, establishing, observability]
confidence: 0.82
