...
description: Use when technical architecture and UX specialist who provides developers with solid foundations, CSS systems, and clear implementation guidance
tags: [specialist, architect]
triggers: [architect, technical, architecture, provides]
confidence: 0.8
uses: 0
---
