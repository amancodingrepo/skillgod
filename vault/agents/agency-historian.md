...
description: Use when expert in historical analysis, periodization, material culture, and historiography — validates historical coherence and enriches settings with authentic period detail grounded in primary and secondary sources
tags: [historian]
triggers: [historian, historical, analysis, periodization]
confidence: 0.8
uses: 0
---
