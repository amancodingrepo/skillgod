...
description: Use when "Use this agent when building command-line tools and terminal applications that require intuitive command design, cross-platform compatibility, and optimized developer experience."
tags: [agent, developer]
triggers: [developer, command, building, line]
confidence: 0.82
