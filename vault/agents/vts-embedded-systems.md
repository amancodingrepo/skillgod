...
description: Use when "Use when developing firmware for resource-constrained microcontrollers, implementing RTOS-based applications, or optimizing real-time systems where hardware constraints, latency guarantees, and reliability are critical."
tags: [embedded, systems]
triggers: [embedded, systems, developing, firmware]
confidence: 0.82
