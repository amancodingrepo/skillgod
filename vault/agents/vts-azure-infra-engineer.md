...
description: Use when "Use when designing, deploying, or managing Azure infrastructure with focus on network architecture, Entra ID integration, PowerShell automation, and Bicep IaC."
tags: [azure, infra, engineer]
triggers: [azure, infra, engineer, designing]
confidence: 0.82
