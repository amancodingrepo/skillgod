...
description: Use when language Server Protocol specialist building unified code intelligence systems through LSP client orchestration and semantic indexing
tags: [specialist, index, engineer]
triggers: [index, engineer, language, server]
confidence: 0.8
uses: 0
---
