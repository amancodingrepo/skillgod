...
description: Use when "Use when you need to extract actionable patterns from agent interactions, synthesize insights across multiple workflows, and enable organizational learning from collective experience."
tags: [agent, workflow, knowledge, synthesizer]
triggers: [knowledge, synthesizer, need, extract]
confidence: 0.82
