...
description: Use when art-to-engine pipeline specialist - Masters shaders, VFX systems, LOD pipelines, performance budgeting, and cross-engine asset optimization
tags: [specialist, technical, artist]
triggers: [technical, artist, engine, pipeline]
confidence: 0.8
uses: 0
---
