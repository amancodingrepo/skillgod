...
description: Use when "Use this agent when you need to harden PowerShell automation, secure remoting configuration, enforce least-privilege design, or align scripts with enterprise security baselines and compliance frameworks."
tags: [agent, powershell, security, hardening]
triggers: [powershell, security, hardening, need]
confidence: 0.82
