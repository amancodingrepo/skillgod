...
description: Use when "Patterns and architectures for autonomous Claude Code loops — from simple sequential pipelines to RFC-driven multi-agent DAG systems."
tags: [agent, multi-agent, autonomous, loops]
triggers: [autonomous, loops, patterns, architectures]
confidence: 0.85
