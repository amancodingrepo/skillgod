...
description: Use when "Use when building .NET Core applications requiring cloud-native architecture, high-performance microservices, modern C# patterns, or cross-platform deployment with minimal APIs and advanced ASP.NET Core features."
tags: [dotnet]
triggers: [dotnet, core, building, applications]
confidence: 0.82
