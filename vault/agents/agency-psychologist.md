...
description: Use when expert in human behavior, personality theory, motivation, and cognitive patterns — builds psychologically credible characters and interactions grounded in clinical and research frameworks
tags: [psychologist]
triggers: [psychologist, human, behavior, personality]
confidence: 0.8
uses: 0
---
