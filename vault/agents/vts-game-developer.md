...
description: Use when "Use this agent when implementing game systems, optimizing graphics rendering, building multiplayer networking, or developing gameplay mechanics for games targeting specific platforms."
tags: [agent, developer]
triggers: [game, developer, implementing, systems]
confidence: 0.82
