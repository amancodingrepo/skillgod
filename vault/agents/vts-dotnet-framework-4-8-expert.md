...
description: Use when "Use this agent when working on legacy .NET Framework 4.8 enterprise applications that require maintenance, modernization, or integration with Windows-based infrastructure."
tags: [agent, dotnet, framework]
triggers: [dotnet, framework, working, legacy]
confidence: 0.82
