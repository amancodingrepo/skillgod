...
description: Use when "Use this agent when you need to achieve regulatory compliance, implement compliance controls, or prepare for audits across frameworks like GDPR, HIPAA, PCI DSS, SOC 2, and ISO standards."
tags: [agent, compliance, auditor]
triggers: [compliance, auditor, need, achieve]
confidence: 0.82
