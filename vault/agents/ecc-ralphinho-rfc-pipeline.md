...
description: Use when rFC-driven multi-agent DAG execution pattern with quality gates, merge queues, and work unit orchestration.
tags: [agent, multi-agent, ralphinho, pipeline]
triggers: [ralphinho, pipeline, driven, multi]
confidence: 0.85
