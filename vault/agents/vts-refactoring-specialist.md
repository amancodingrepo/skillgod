...
description: Use when "Use when you need to transform poorly structured, complex, or duplicated code into clean, maintainable systems while preserving all existing behavior."
tags: [specialist, refactoring]
triggers: [refactoring, need, transform, poorly]
confidence: 0.82
