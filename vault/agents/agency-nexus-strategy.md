...
description: Use when # 🌐 NEXUS — Network of EXperts, Unified in Strategy  ## The Agency's Complete Operational Playbook for Multi-Agent Orche
tags: [agent, multi-agent, nexus, strategy]
triggers: [nexus, strategy, network, experts]
confidence: 0.8
uses: 0
---
