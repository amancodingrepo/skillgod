...
description: Use when "Use when managing Windows Server infrastructure, Active Directory, DNS, DHCP, and Group Policy configurations, especially for enterprise-scale deployments requiring safe automation and compliance validation."
tags: [windows, infra, admin]
triggers: [windows, infra, admin, managing]
confidence: 0.82
