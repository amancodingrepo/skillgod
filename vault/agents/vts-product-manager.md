...
description: Use when "Use this agent when you need to make product strategy decisions, prioritize features, or define roadmap plans based on user needs and business goals."
tags: [agent, product, manager]
triggers: [product, manager, need, make]
confidence: 0.82
