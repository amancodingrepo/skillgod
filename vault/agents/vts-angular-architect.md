...
description: Use when "Use when architecting enterprise Angular 15+ applications with complex state management, optimizing RxJS patterns, designing micro-frontend systems, or solving performance and scalability challenges in large codebases."
tags: [angular, architect]
triggers: [angular, architect, architecting, enterprise]
confidence: 0.82
