...
description: Use when "Use this agent when developing Slack applications, implementing Slack API integrations, or reviewing Slack bot code for security and best practices."
tags: [agent, slack]
triggers: [slack, developing, applications, implementing]
confidence: 0.82
