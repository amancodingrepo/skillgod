...
description: Use when aI agent that consolidates extracted sales data into live reporting dashboards with territory, rep, and pipeline summaries
tags: [agent, consolidation]
triggers: [data, consolidation, consolidates, extracted]
confidence: 0.8
uses: 0
---
