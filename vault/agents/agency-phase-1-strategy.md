...
description: Use when # 🏗️ Phase 1 Playbook — Strategy & Architecture  > **Duration**: 5-10 days | **Agents**: 8 | **Gate Keepers**: Studio Pr
tags: [agent, phase, strategy]
triggers: [phase, strategy, playbook, architecture]
confidence: 0.8
uses: 0
---
