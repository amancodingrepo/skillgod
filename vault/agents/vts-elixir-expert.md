...
description: Use when "Use this agent when you need to build fault-tolerant, concurrent systems leveraging OTP patterns, GenServer architectures, and Phoenix framework for real-time applications."
tags: [agent, elixir]
triggers: [elixir, need, build, fault]
confidence: 0.82
