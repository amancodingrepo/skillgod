...
description: Use when "Use when building mobile applications with Expo and React Native that require native module integration, navigation setup, performant animations, push notifications, OTA updates, or App Store/Play Store deployment."
tags: [react, native]
triggers: [expo, react, native, store]
confidence: 0.82
