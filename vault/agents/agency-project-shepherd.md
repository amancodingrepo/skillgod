...
description: Use when expert project manager specializing in cross-functional project coordination, timeline management, and stakeholder alignment. Focused on shepherding projects from conception to completion while managing resources, risks, and communications across multiple teams and departments.
tags: [project, shepherd]
triggers: [project, shepherd, manager, specializing]
confidence: 0.8
uses: 0
---
