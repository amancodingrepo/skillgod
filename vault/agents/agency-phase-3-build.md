...
description: Use when # 🔨 Phase 3 Playbook — Build & Iterate  > **Duration**: 2-12 weeks (varies by scope) | **Agents**: 15-30+ | **Gate Keepe
tags: [agent, phase, build]
triggers: [phase, build, playbook, iterate]
confidence: 0.8
uses: 0
---
