...
description: Use when "Use this agent when architecting, implementing, or optimizing end-to-end AI systems—from model selection and training pipelines to production deployment and monitoring."
tags: [agent, engineer]
triggers: [engineer, architecting, implementing, optimizing]
confidence: 0.82
