...
description: Use when expert WeChat Mini Program developer specializing in 小程序 development with WXML/WXSS/WXS, WeChat API integration, payment systems, subscription messaging, and the full WeChat ecosystem.
tags: [wechat, program, developer]
triggers: [wechat, mini, program, developer]
confidence: 0.8
uses: 0
---
