...
description: Use when "Use this agent when modernizing legacy systems that need incremental migration strategies, technical debt reduction, and risk mitigation while maintaining business continuity."
tags: [agent, legacy, modernizer]
triggers: [legacy, modernizer, modernizing, systems]
confidence: 0.82
