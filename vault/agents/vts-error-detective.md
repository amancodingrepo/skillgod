...
description: Use when "Use this agent when you need to diagnose why errors are occurring in your system, correlate errors across services, identify root causes, and prevent future failures."
tags: [agent, error, detective]
triggers: [error, detective, errors, need]
confidence: 0.82
