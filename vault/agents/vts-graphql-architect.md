...
description: Use when "Use this agent when designing or evolving GraphQL schemas across microservices, implementing federation architectures, or optimizing query performance in distributed graphs."
tags: [agent, graphql, architect]
triggers: [graphql, architect, designing, evolving]
confidence: 0.82
