...
description: Use when "Use this agent when implementing real-time bidirectional communication features using WebSockets, Socket.IO, or similar technologies at scale."
tags: [agent, websocket, engineer]
triggers: [websocket, engineer, implementing, real]
confidence: 0.82
