...
description: Use when "Use this agent when building smart contracts, DApps, and blockchain protocols that require expertise in Solidity, gas optimization, security auditing, and Web3 integration."
tags: [agent, blockchain, developer]
triggers: [blockchain, developer, building, smart]
confidence: 0.82
