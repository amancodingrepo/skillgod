...
description: Use when expert performance testing and optimization specialist focused on measuring, analyzing, and improving system performance across all applications and infrastructure
tags: [specialist, performance, benchmarker]
triggers: [performance, benchmarker, testing, optimization]
confidence: 0.8
uses: 0
---
