...
description: Use when "Use when teams need facilitation, process optimization, velocity improvement, or agile ceremony management—especially for sprint planning, retrospectives, impediment removal, and scaling agile practices across multiple teams."
tags: [scrum, master]
triggers: [scrum, master, teams, agile]
confidence: 0.82
