...
description: Use when expert in physical and human geography, climate systems, cartography, and spatial analysis — builds geographically coherent worlds where terrain, climate, resources, and settlement patterns make scientific sense
tags: [geographer]
triggers: [geographer, climate, physical, human]
confidence: 0.8
uses: 0
---
