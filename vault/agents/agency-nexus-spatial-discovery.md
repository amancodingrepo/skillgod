...
description: Use when # Nexus Spatial: Full Agency Discovery Exercise  > **Exercise type:** Multi-agent product discovery > **Date:** March 5,
tags: [agent, multi-agent, nexus, spatial, discovery]
triggers: [nexus, spatial, discovery, exercise]
confidence: 0.8
uses: 0
---
