...
description: Use when "Use this agent when you need to optimize build performance, reduce compilation times, or scale build systems across growing teams."
tags: [agent, build, engineer]
triggers: [build, engineer, need, optimize]
confidence: 0.82
