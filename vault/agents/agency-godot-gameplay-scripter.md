...
description: Use when composition and signal integrity specialist - Masters GDScript 2.0, C# integration, node-based architecture, and type-safe signal design for Godot 4 projects
tags: [specialist, godot, gameplay, scripter]
triggers: [godot, gameplay, scripter, signal]
confidence: 0.8
uses: 0
---
