...
description: Use when # Multi-Agent Workflow: Startup MVP  > A step-by-step example of how to coordinate multiple agents to go from idea to sh
tags: [agent, multi-agent, workflow, startup]
triggers: [workflow, startup, step, multi]
confidence: 0.8
uses: 0
---
