...
description: Use when stops fantasy approvals, evidence-based certification - Default to "NEEDS WORK", requires overwhelming proof for production readiness
tags: [reality, checker]
triggers: [reality, checker, stops, fantasy]
confidence: 0.8
uses: 0
---
