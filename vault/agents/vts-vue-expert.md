...
description: Use when "Use this agent when building Vue 3 applications that require Composition API mastery, reactivity optimization, or Nuxt 3 development with enterprise-scale performance concerns."
tags: [agent]
triggers: [building, applications, require, composition]
confidence: 0.82
