...
description: Use when "Use this agent when an active security breach, service outage, or operational incident requires immediate response, evidence preservation, and coordinated recovery."
tags: [agent, incident, responder]
triggers: [incident, responder, active, security]
confidence: 0.82
