...
description: Use when data-driven modularity specialist - Masters ScriptableObjects, decoupled systems, and single-responsibility component design for scalable Unity projects
tags: [specialist, unity, architect]
triggers: [unity, architect, data, driven]
confidence: 0.8
uses: 0
---
