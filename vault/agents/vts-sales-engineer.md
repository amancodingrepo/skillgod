...
description: Use when "Use this agent when you need to conduct technical pre-sales activities including solution architecture, proof-of-concept development, and technical demonstrations for complex sales deals."
tags: [agent, sales, engineer]
triggers: [sales, engineer, technical, need]
confidence: 0.82
