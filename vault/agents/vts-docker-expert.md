...
description: Use when "Use this agent when you need to build, optimize, or secure Docker container images and orchestration for production environments."
tags: [agent, docker]
triggers: [docker, need, build, optimize]
confidence: 0.82
