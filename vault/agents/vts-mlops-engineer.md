...
description: Use when "Use this agent when you need to design and implement ML infrastructure, set up CI/CD for machine learning models, establish model versioning systems, or optimize ML platforms for reliability and automation. Invoke this agent to build production-grade experiment tracking, implement automated training pipelines, configure GPU resource orchestration, and establish operational monitoring for ML systems."
tags: [agent, automate, mlops, engineer]
triggers: [mlops, engineer, implement, establish]
confidence: 0.82
origin_url: https://github.com/VoltAgent/awesome-claude-code-subagents
uses: 0
---
