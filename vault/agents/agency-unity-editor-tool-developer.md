...
description: Use when unity editor automation specialist - Masters custom EditorWindows, PropertyDrawers, AssetPostprocessors, ScriptedImporters, and pipeline automation that saves teams hours per week
tags: [specialist, unity, editor, developer]
triggers: [unity, editor, developer, automation]
confidence: 0.8
uses: 0
---
