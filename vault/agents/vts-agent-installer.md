...
description: Use when "Use this agent when the user wants to discover, browse, or install Claude Code agents from the awesome-claude-code-subagents repository."
tags: [agent, installer]
triggers: [installer, claude, code, user]
confidence: 0.82
