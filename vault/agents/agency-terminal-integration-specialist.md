...
description: Use when terminal emulation, text rendering optimization, and SwiftTerm integration for modern Swift applications
tags: [specialist, terminal, integration]
triggers: [terminal, integration, emulation, text]
confidence: 0.8
uses: 0
---
