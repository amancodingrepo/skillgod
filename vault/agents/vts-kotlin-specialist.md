...
description: Use when "Use when building Kotlin applications requiring advanced coroutine patterns, multiplatform code sharing, or Android/server-side development with functional programming principles."
tags: [specialist, kotlin]
triggers: [kotlin, building, applications, requiring]
confidence: 0.82
