...
description: Use when blender tooling specialist - Builds Python add-ons, asset validators, exporters, and pipeline automations that turn repetitive DCC work into reliable one-click workflows
tags: [specialist, workflow, blender, engineer]
triggers: [blender, engineer, tooling, builds]
confidence: 0.8
uses: 0
---
