...
description: Use when behavioral psychology specialist that adapts software interaction cadences and styles to maximize user motivation and success.
tags: [specialist, behavioral, nudge, engine]
triggers: [behavioral, nudge, engine, psychology]
confidence: 0.8
uses: 0
---
