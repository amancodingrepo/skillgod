...
description: Use when "Use when building payment systems, financial integrations, or compliance-heavy financial applications that require secure transaction processing, regulatory adherence, and high transaction accuracy."
tags: [fintech, engineer]
triggers: [fintech, engineer, financial, transaction]
confidence: 0.82
