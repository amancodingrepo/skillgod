...
description: Use when display advertising and programmatic media buying specialist covering managed placements, Google Display Network, DV360, trade desk platforms, partner media (newsletters, sponsored content), and ABM display strategies via platforms like Demandbase and 6Sense.
tags: [specialist, programmatic, display, buyer]
triggers: [programmatic, display, buyer, media]
confidence: 0.8
uses: 0
---
