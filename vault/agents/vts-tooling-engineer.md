...
description: Use when "Use this agent when you need to build or enhance developer tools including CLIs, code generators, build tools, and IDE extensions."
tags: [agent, tooling, engineer]
triggers: [tooling, engineer, build, tools]
confidence: 0.82
