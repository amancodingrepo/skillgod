...
description: Use when expert technical compliance auditor specializing in SOC 2, ISO 27001, HIPAA, and PCI-DSS audits — from readiness assessment through evidence collection to certification.
tags: [compliance, auditor]
triggers: [compliance, auditor, technical, specializing]
confidence: 0.8
uses: 0
---
