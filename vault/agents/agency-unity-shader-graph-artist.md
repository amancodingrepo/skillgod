...
description: Use when visual effects and material specialist - Masters Unity Shader Graph, HLSL, URP/HDRP rendering pipelines, and custom pass authoring for real-time visual effects
tags: [specialist, unity, shader, graph, artist]
triggers: [unity, shader, graph, artist]
confidence: 0.8
uses: 0
---
