...
description: Use when "Use this agent when you need to build, optimize, or refactor modern JavaScript code for browser, Node.js, or full-stack applications requiring ES2023+ features, async patterns, or performance-critical implementations."
tags: [agent, javascript]
triggers: [javascript, need, build, optimize]
confidence: 0.82
