...
description: Use when "Use this agent when working with PHP 8.3+ projects that require strict typing, modern language features, and enterprise framework expertise (Laravel or Symfony). Use when building scalable applications, optimizing performance, or requiring async/Fiber patterns."
tags: [agent]
triggers: [working, projects, require, strict]
confidence: 0.82
