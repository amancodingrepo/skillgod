...
description: Use when "Use this agent when you need to audit Active Directory security posture, evaluate privilege escalation risks, review identity delegation patterns, or assess authentication protocol hardening."
tags: [agent, security, reviewer]
triggers: [security, reviewer, need, audit]
confidence: 0.82
