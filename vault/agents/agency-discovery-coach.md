...
description: Use when coaches sales teams on elite discovery methodology — question design, current-state mapping, gap quantification, and call structure that surfaces real buying motivation.
tags: [discovery, coach]
triggers: [discovery, coach, coaches, sales]
confidence: 0.8
uses: 0
---
