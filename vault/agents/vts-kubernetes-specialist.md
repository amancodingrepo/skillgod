...
description: Use when "Use this agent when you need to design, deploy, configure, or troubleshoot Kubernetes clusters and workloads in production environments."
tags: [agent, specialist, kubernetes]
triggers: [kubernetes, need, design, deploy]
confidence: 0.82
