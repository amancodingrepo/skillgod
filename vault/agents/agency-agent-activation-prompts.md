...
description: Use when # 🎯 NEXUS Agent Activation Prompts  > Ready-to-use prompt templates for activating any agent within the NEXUS pipeline.
tags: [agent, activation, prompts]
triggers: [activation, prompts, nexus, ready]
confidence: 0.8
uses: 0
---
