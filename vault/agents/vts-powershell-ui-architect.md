...
description: Use when "Use when designing or building desktop graphical interfaces (WinForms, WPF, Metro-style dashboards) or terminal user interfaces (TUIs) for PowerShell automation tools that need clean separation between UI and business logic."
tags: [powershell, architect]
triggers: [powershell, architect, interfaces, designing]
confidence: 0.82
