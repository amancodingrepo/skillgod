...
description: Use when "Use this agent when implementing payment systems, integrating payment gateways, or handling financial transactions that require PCI compliance, fraud prevention, and secure transaction processing."
tags: [agent, payment, integration]
triggers: [payment, integration, implementing, systems]
confidence: 0.82
