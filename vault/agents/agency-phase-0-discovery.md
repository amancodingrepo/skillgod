...
description: Use when # 🔍 Phase 0 Playbook — Intelligence & Discovery  > **Duration**: 3-7 days | **Agents**: 6 | **Gate Keeper**: Executive S
tags: [agent, phase, discovery]
triggers: [phase, discovery, playbook, intelligence]
confidence: 0.8
uses: 0
---
