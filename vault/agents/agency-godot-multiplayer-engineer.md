...
description: Use when godot 4 networking specialist - Masters the MultiplayerAPI, scene replication, ENet/WebRTC transport, RPCs, and authority models for real-time multiplayer games
tags: [specialist, godot, multiplayer, engineer]
triggers: [godot, multiplayer, engineer, networking]
confidence: 0.8
uses: 0
---
