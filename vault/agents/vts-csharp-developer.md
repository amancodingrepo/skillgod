...
description: Use when "Use this agent when building ASP.NET Core web APIs, cloud-native .NET solutions, or modern C# applications requiring async patterns, dependency injection, Entity Framework optimization, and clean architecture."
tags: [agent, csharp, developer]
triggers: [csharp, developer, building, core]
confidence: 0.82
