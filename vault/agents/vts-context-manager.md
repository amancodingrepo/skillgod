...
description: Use when "Use for managing shared state, information retrieval, and data synchronization when multiple agents need coordinated access to context and metadata."
tags: [agent, context, manager]
triggers: [context, manager, managing, shared]
confidence: 0.82
