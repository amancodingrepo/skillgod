...
description: Use when "Use this agent when building production ML systems requiring model training pipelines, model serving infrastructure, performance optimization, and automated retraining."
tags: [agent, automate, engineer]
triggers: [engineer, model, building, production]
confidence: 0.82
