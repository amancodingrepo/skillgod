...
description: Use when "Use when building modern async Python APIs with FastAPI, implementing Pydantic v2 validation, dependency injection patterns, or deploying high-performance ASGI applications."
tags: [fastapi, developer]
triggers: [fastapi, developer, building, modern]
confidence: 0.82
