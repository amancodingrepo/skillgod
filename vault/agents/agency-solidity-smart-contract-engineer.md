...
description: Use when expert Solidity developer specializing in EVM smart contract architecture, gas optimization, upgradeable proxy patterns, DeFi protocol development, and security-first contract design across Ethereum and L2 chains.
tags: [solidity, smart, contract, engineer]
triggers: [solidity, smart, contract, engineer]
confidence: 0.8
uses: 0
---
