...
description: Use when godot 4 visual effects specialist - Masters the Godot Shading Language (GLSL-like), VisualShader editor, CanvasItem and Spatial shaders, post-processing, and performance optimization for 2D/3D effects
tags: [specialist, godot, shader, developer]
triggers: [godot, shader, developer, effects]
confidence: 0.8
uses: 0
---
