...
description: Use when "Multi-agent adversarial verification with convergence loop. Two independent review agents must both pass before output ships."
tags: [agent, multi-agent, loop, santa, method]
triggers: [santa, method, multi, adversarial]
confidence: 0.85
