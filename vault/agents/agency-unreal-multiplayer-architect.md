...
description: Use when unreal Engine networking specialist - Masters Actor replication, GameMode/GameState architecture, server-authoritative gameplay, network prediction, and dedicated server setup for UE5
tags: [specialist, unreal, multiplayer, architect]
triggers: [unreal, multiplayer, architect, server]
confidence: 0.8
uses: 0
---
