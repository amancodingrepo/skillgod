...
description: Use when governance-first architect for business automations (n8n-first) who audits value, risk, and maintainability before implementation.
tags: [automation, governance, architect]
triggers: [automation, governance, architect, first]
confidence: 0.8
uses: 0
---
