...
description: Use when expert application security engineer specializing in threat modeling, vulnerability assessment, secure code review, and security architecture design for modern web and cloud-native applications.
tags: [security, engineer]
triggers: [security, engineer, application, specializing]
confidence: 0.8
uses: 0
---
