...
description: Use when roblox UGC and avatar pipeline specialist - Masters Roblox's avatar system, UGC item creation, accessory rigging, texture standards, and the Creator Marketplace submission pipeline
tags: [specialist, roblox, avatar, creator]
triggers: [roblox, avatar, creator, pipeline]
confidence: 0.8
uses: 0
---
