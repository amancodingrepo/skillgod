...
description: Use when "Use this agent when you need to design, establish, or optimize Git workflows, branching strategies, and merge management for a project or team."
tags: [agent, workflow, manager]
triggers: [workflow, manager, need, design]
confidence: 0.82
