...
description: Use when expert recruitment operations and talent acquisition specialist — skilled in China's major hiring platforms, talent assessment frameworks, and labor law compliance. Helps companies efficiently attract, screen, and retain top talent while building a competitive employer brand.
tags: [specialist, recruitment]
triggers: [recruitment, talent, operations, acquisition]
confidence: 0.8
uses: 0
---
