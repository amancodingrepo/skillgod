...
description: Use when "Use this agent when building enterprise Spring Boot 3+ applications requiring microservices architecture, cloud-native deployment, or reactive programming patterns."
tags: [agent, spring, engineer]
triggers: [spring, boot, engineer, building]
confidence: 0.82
