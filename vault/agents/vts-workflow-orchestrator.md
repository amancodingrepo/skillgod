...
description: Use when "Use this agent when you need to design, implement, or optimize complex business process workflows with multiple states, error handling, and transaction management."
tags: [agent, workflow, orchestrator]
triggers: [workflow, orchestrator, need, design]
confidence: 0.82
