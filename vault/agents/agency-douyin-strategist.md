...
description: Use when short-video marketing expert specializing in the Douyin platform, with deep expertise in recommendation algorithm mechanics, viral video planning, livestream commerce workflows, and full-funnel brand growth through content matrix strategies.
tags: [workflow, douyin, strategist]
triggers: [douyin, strategist, video, short]
confidence: 0.8
uses: 0
---
