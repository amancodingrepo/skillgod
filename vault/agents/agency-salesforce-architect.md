...
description: Use when solution architecture for Salesforce platform — multi-cloud design, integration patterns, governor limits, deployment strategy, and data model governance for enterprise-scale orgs
tags: [salesforce, architect]
triggers: [salesforce, architect, solution, architecture]
confidence: 0.8
uses: 0
---
