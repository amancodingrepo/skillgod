...
description: Use when aI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters
tags: [agent, automate, report, distribution]
triggers: [report, distribution, automates, consolidated]
confidence: 0.8
uses: 0
---
