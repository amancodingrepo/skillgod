...
description: Use when "Scan skills to extract cross-cutting principles and distill them into rules — append, revise, or create new rule files"
tags: [rule, rules, distill]
triggers: [rules, distill, scan, skills]
confidence: 0.85
