...
description: Use when clean Architecture patterns for Android and Kotlin Multiplatform projects — module structure, dependency rules, UseCases, Repositories, and data layer patterns.
tags: [rule, android, clean, architecture]
triggers: [android, clean, architecture, patterns]
confidence: 0.85
