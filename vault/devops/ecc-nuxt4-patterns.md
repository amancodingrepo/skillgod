...
description: Use when nuxt 4 app patterns for hydration safety, performance, route rules, lazy loading, and SSR-safe data fetching with useFetch and useAsyncData.
tags: [cd, patterns]
triggers: [patterns, nuxt, hydration, safety]
confidence: 0.85
