...
description: Use when deploy applications and websites to Vercel. Use when the user requests deployment actions like "deploy my app", "deploy and give me the link", "push this live", or "create a preview deployment".
tags: [deploy, vercel]
triggers: [deploy, vercel, deployment, applications]
confidence: 0.88
origin_url: https://github.com/vercel-labs/agent-skills/tree/main/skills/deploy-to-vercel/SKILL.md
uses: 0
---
