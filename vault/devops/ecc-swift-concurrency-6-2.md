...
description: Use when swift 6.2 Approachable Concurrency — single-threaded by default, @concurrent for explicit background offloading, isolated conformances for main actor types.
tags: [ci, swift, concurrency]
triggers: [swift, concurrency, approachable, single]
confidence: 0.85
