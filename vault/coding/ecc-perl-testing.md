...
description: Use when perl testing patterns using Test2::V0, Test::More, prove runner, mocking, coverage with Devel::Cover, and TDD methodology.
tags: [testing]
triggers: [perl, testing, patterns, using]
confidence: 0.85
