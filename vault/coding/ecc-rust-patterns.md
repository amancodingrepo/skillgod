...
description: Use when idiomatic Rust patterns, ownership, error handling, traits, concurrency, and best practices for building safe, performant applications.
tags: [error handling, patterns]
triggers: [rust, patterns, idiomatic, ownership]
confidence: 0.85
