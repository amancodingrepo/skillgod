...
description: Use when test-driven development for Laravel with PHPUnit and Pest, factories, database testing, fakes, and coverage targets.
tags: [laravel]
triggers: [laravel, test, driven, development]
confidence: 0.85
