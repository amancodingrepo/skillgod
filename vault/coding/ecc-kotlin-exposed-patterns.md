...
description: Use when jetBrains Exposed ORM patterns including DSL queries, DAO pattern, transactions, HikariCP connection pooling, Flyway migrations, and repository pattern.
tags: [kotlin, exposed, patterns]
triggers: [kotlin, exposed, patterns, pattern]
confidence: 0.85
