...
description: Use when development conventions and patterns for everything-claude-code. JavaScript project with conventional commits.
tags: [javascript, everything, claude, conventions]
triggers: [everything, claude, code, conventions]
confidence: 0.85
