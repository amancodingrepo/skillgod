...
description: Use when anthropic Claude API patterns for Python and TypeScript. Covers Messages API, streaming, tool use, vision, extended thinking, batches, prompt caching, and Claude Agent SDK. Use when building applications with the Claude API or Anthropic SDKs.
tags: [python, typescript, claude]
triggers: [claude, anthropic, patterns, python]
confidence: 0.85
