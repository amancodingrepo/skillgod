...
description: Use when kotlin Coroutines and Flow patterns for Android and KMP — structured concurrency, Flow operators, StateFlow, error handling, and testing.
tags: [error handling, kotlin, coroutines, flows]
triggers: [kotlin, coroutines, flows, flow]
confidence: 0.85
