...
description: Use when idiomatic Kotlin patterns, best practices, and conventions for building robust, efficient, and maintainable Kotlin applications with coroutines, null safety, and DSL builders.
tags: [kotlin, patterns]
triggers: [kotlin, patterns, idiomatic, best]
confidence: 0.85
