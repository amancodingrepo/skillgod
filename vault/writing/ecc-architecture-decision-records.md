...
description: Use when capture architectural decisions made during Claude Code sessions as structured ADRs. Auto-detects decision moments, records context, alternatives considered, and rationale. Maintains an ADR log so future developers understand why the codebase is shaped the way it is.
tags: [architecture, decision, records]
triggers: [architecture, decision, records, capture]
confidence: 0.85
