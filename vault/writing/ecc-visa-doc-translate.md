...
description: Use when translate visa application documents (images) to English and create a bilingual PDF with original and translation
tags: [document, translate]
triggers: [visa, translate, application, documents]
confidence: 0.85
