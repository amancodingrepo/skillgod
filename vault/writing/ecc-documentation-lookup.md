...
description: Use when use up-to-date library and framework docs via Context7 MCP instead of training data. Activates for setup questions, API references, code examples, or when the user names a framework (e.g. React, Next.js, Prisma).
tags: [document, docs, documentation, lookup]
triggers: [documentation, lookup, framework, date]
confidence: 0.85
