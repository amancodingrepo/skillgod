...
description: Use when database migration best practices for schema changes, data migrations, rollbacks, and zero-downtime deployments across PostgreSQL, MySQL, and common ORMs (Prisma, Drizzle, Kysely, Django, TypeORM, golang-migrate).
tags: [post, database, migrations]
triggers: [database, migrations, migration, best]
confidence: 0.85
