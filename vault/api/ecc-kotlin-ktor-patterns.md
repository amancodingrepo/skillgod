...
description: Use when ktor server patterns including routing DSL, plugins, authentication, Koin DI, kotlinx.serialization, WebSockets, and testApplication testing.
tags: [kotlin, patterns]
triggers: [kotlin, ktor, patterns, server]
confidence: 0.85
