...
description: Use when django testing strategies with pytest-django, TDD methodology, factory_boy, mocking, coverage, and testing Django REST Framework APIs.
tags: [api, rest, django]
triggers: [django, testing, strategies, pytest]
confidence: 0.85
